...
function LiveSecretaPage() {
  ...
  const checks = (
    <ul className="space-y-1.5 md:space-y-2 text-xs sm:text-sm md:text-[15px] leading-snug">
  ...
  return (
    <main className="min-h-screen w-full bg-black text-white flex flex-col">
      ...
      <section className="mx-auto w-full max-w-6xl px-4 sm:px-6 py-4 md:py-6 grid md:grid-cols-[1fr_minmax(260px,380px)] gap-6 items-start">
        {/* Bloco 1 */}
        <div className="flex flex-col">
          <div
            className="inline-flex self-start items-center gap-2 border rounded-md px-2.5 py-1.5 text-[10px] sm:text-xs font-semibold uppercase tracking-wide mb-3"
