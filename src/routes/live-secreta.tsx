...
function LiveSecretaPage() {
  ...
  return (
    <main className="min-h-screen md:h-screen w-full bg-black text-white flex flex-col md:overflow-hidden">
      ...
      {/* Bloco único — preenche o resto da tela */}
      <section className="flex-1 min-h-0 mx-auto w-full max-w-6xl px-4 sm:px-6 py-3 md:py-4 grid md:grid-cols-[1fr_minmax(220px,340px)] gap-4 md:gap-6 items-center">
        {/* Coluna esquerda — conteúdo */}
        <div className="flex flex-col justify-center min-h-0">
          <div
            className="inline-flex self-start items-center gap-2 border rounded-md px-2.5 py-1.5 text-[10px] sm:text-xs font-semibold uppercase tracking-wide mb-2 md:mb-3"
          ...
          <h1 className="text-lg sm:text-2xl md:text-3xl font-extrabold leading-[1.15] mb-2 md:mb-3">
          ...
          <ul className="space-y-1.5 md:space-y-2 mb-3 md:mb-4 text-xs sm:text-sm md:text-[15px] leading-snug">
            <li className="flex gap-2">
              <Check size={16} strokeWidth={3} className="shrink-0 mt-0.5" style={{ color: RED }} />
          ...
          <div className="md:hidden flex justify-center -mt-14 -mb-2">
            <img
              src={drFrancisco.url}
        ...
        {/* Coluna direita — Dr. Francisco grudado no botão */}
        <div className="hidden md:flex h-full flex-col items-center justify-end">
          <img
            src={drFrancisco.url}
            alt="Dr. Francisco Amaral — Anestesista Obstétrico"
