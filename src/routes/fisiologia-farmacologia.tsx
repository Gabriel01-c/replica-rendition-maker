            ...
            <div className="flex flex-col text-white">
              ...
              <ul className="mb-3 grid grid-cols-2 gap-x-2 gap-y-1.5 md:mb-5 md:gap-x-3 md:gap-y-2">
                {[
                  ...
                  <li key={item} className="flex items-center gap-1.5 text-[11px] text-white/90 md:text-sm">
                    <span className="shrink-0 text-sm leading-none md:text-base" style={{ color: TEAL }}>
                      ✅
                    </span>
