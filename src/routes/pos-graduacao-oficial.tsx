          ...
          <div className="relative order-1 lg:hidden">
            <div className="relative mx-auto max-w-md">
              ...
              <img
                src={anhanguera.url}
                alt="Anhanguera"
                className="pointer-events-none absolute left-2 bottom-16 w-28 select-none drop-shadow-[0_6px_16px_rgba(0,0,0,0.5)] sm:bottom-20 sm:w-32"
                draggable={false}
              />
              <img
                src={reconhecidoMec.url}
                alt="Reconhecido pelo MEC"
                className="pointer-events-none absolute right-2 bottom-14 w-28 select-none drop-shadow-[0_6px_16px_rgba(0,0,0,0.5)] sm:bottom-18 sm:w-32"
                draggable={false}
              />
            </div>
          ...
          <div className="relative order-3 hidden lg:order-2 lg:block lg:h-full">
            <div className="relative mx-auto flex h-full min-h-[560px] items-end justify-center">
              ...
              <img
                src={anhanguera.url}
                alt="Anhanguera"
                className="pointer-events-none absolute left-4 bottom-10 w-40 select-none drop-shadow-[0_10px_24px_rgba(0,0,0,0.55)] xl:bottom-14 xl:w-48"
                draggable={false}
              />
              <img
                src={reconhecidoMec.url}
                alt="Reconhecido pelo MEC"
                className="pointer-events-none absolute right-6 bottom-10 w-40 select-none drop-shadow-[0_10px_24px_rgba(0,0,0,0.55)] xl:bottom-14 xl:w-48"
                draggable={false}
              />
            </div>
          </div>
