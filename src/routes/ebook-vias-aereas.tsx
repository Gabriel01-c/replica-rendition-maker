    ...
    scripts: [
      {
        ...
        children: `(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-PD6G9FZT');`,
      },
    ],
  }),
  component: Page,
      ...
      <div className="va-root">
        ...
        <section ref={aboutRef} className="section relative pb-32">
          <div className="container max-w-3xl text-center">
            ...
            <div className="section-sub space-y-2 reveal mb-0 max-w-2xl mx-auto">
              <p>
